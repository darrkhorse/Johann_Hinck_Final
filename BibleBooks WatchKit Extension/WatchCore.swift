...
class WatchCore: NSObject
{
    ...
    static var correctGuesses = [String]()
    ...
    static var bibleBooksArray = bibleBooksString.componentsSeparatedByString(",")
    //Couldn't figure out how to randomize order
    static var bibleBooksArrayShuffled = bibleBooksArray
